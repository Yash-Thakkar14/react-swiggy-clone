...
it("should search ba in text input", async () => {
  ...
  expect(initialCards.length).toBe(17); // Assuming the initial mock data has 10 restaurants
  ...
  // Assertion to check if the search on change then cards presnt will be only 4
